...
class Schwab529Module:
    ...
    def attribute_transactions(
        ...
        Args:
            ...
            structure (list[dict[str, Any]] | None): The shape of the
            transaction markup, reported when rows cannot be attributed so the
            next run does not need someone to read the HTML by hand.
    ...
    def _report_unattributed(
        ...
        Args:
            ...
            structure (list[dict[str, Any]] | None): The markup's shape.
    ...
    @staticmethod
    def _log_structure(
        context: Context, structure: list[dict[str, Any]] | None
    ) -> None:
        ...
        Args:
            context (Context): Used for logging.
            structure (list[dict[str, Any]] | None): One entry per table.
